...
jQuery( document ).ready( function($) {
	...
	function smoothScrollAnchors() {
		...
		// AA: negative [href="#collapsibleServices"] added, not to mess up with the collapsible services menu
		$('a[href*="#"]:not([href="#"],[href="#collapsibleServices"])').on('click', function() {
