...
/* I reordered sections in this file, so that the contact details are below the order form */
...
<section id="contact-us" class="front-page-section">
	...
	<div class="section-content">
		...
		<div class="container">
			<!-- Amade: I moded this section to have the form above the contact details -->
			<!-- Amade: also added bottom padding of 50px, to separate contact form from the contact details -->
			<div class="row">
