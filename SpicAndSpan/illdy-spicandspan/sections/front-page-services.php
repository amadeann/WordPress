...
<section id="services" class="front-page-section">
	...
	<div class="section-content">
		...
		<div class="container">
			...
			<!-- AA: START CUSTOM EDIT -->
			<!-- Adding a collapsible services sidebar -->
			<!-- Sidebar works just like a native Illdy services sidebar, only that is is collapsible -->
			<?php
				// AA: Show the collapsible header only when Collapsible Services Sidebar is active
			if( is_active_sidebar( 'front-page-collapsible-services-sidebar' ) ):
			?>
			<div class="row">
			...
			<?php
				dynamic_sidebar( 'front-page-collapsible-services-sidebar' );
			?>
			</div>
			<?php
			endif;
